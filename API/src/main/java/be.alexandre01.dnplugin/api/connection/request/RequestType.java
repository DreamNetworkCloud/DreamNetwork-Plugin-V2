...
public abstract class RequestType {
    ...
    @Deprecated public final static RequestInfo CORE_RETRANSMISSION =  new RequestInfo(6,"CORE_RETRANSMISSION");
    ...
    public final static RequestInfo CORE_KILL_SERVER =  new RequestInfo(9,"CORE_KILL_SERVER");
    ...
    static final Map<String,Integer> byName = new HashMap<String, Integer>();
    ...
    public static Integer getIdByName(String name) throws IDNotFoundException{
    ...
    public static void addCacheRequestInfo(String name, int id){
        byName.put(name,id);
    }
